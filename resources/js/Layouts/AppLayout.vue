<template>
    <div >
        ...
        <div class="min-h-screen bg-indigo-50 overflow-y-auto dark:bg-cat-hard-5">
            <nav class="bg-cat-dark-light  border-gray-600 dark:bg-cat-hard-5">
                        ...
                        <div class="flex">
                            ...
                            <div class="hidden space-x-8 sm:-my-px sm:ml-10 sm:flex">
                                <jet-nav-link :href="route('messenger')" :active="route().current('messenger')">
                                    <span class="font-medium text-base">Messenger</span>
                                </jet-nav-link>
                            </div>
                            <div class="hidden space-x-8 sm:-my-px sm:ml-10 sm:flex">
                                <jet-nav-link :href="route('stats.index')" :active="route().current('stats.index')">
                                    <span class="font-medium text-base">Stats</span>
                                </jet-nav-link>
                            </div>
                        </div>
                                ...
                                <jet-dropdown align="right" width="48">
                                    <template #trigger>
                                        ...
                                        <span v-else class="inline-flex rounded-md">
                                            <button type="button" class="inline-flex items-center px-3 py-2 border border-transparent text-sm leading-4 font-medium rounded-md text-gray-200 dark:dark:bg-cat-hard-blue-1 hover:text-gray-300 focus:outline-none transition">
            ...
            <!-- Page Heading -->
            <header class="bg-cat-light-1 dark:bg-cat-hard-4 shadow" v-if="$slots.header">
