<template>
    <div class="col-span-12 sm:col-span-6 md:col-span-3">
        <div class="flex flex-row bg-white shadow-sm rounded p-4 dark:bg-cat">
            ...
            <div class="flex flex-col flex-grow ml-4">
              <div class="text-sm text-gray-500 dark:text-gray-300">{{option.title}}</div>
              <div class="font-bold text-lg dark:text-white">{{text}}</div>
            </div>
        </div>
    </div>
</template>
