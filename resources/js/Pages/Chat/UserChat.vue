<template>
  <div @click="$emit('mostrarConversacion')" 
      class="my-2 mr-4 p-2 flex cursor-pointer rounded-lg hover:bg-gray-200 hover:bg-opacity-50"
      :class="chatColor,select">
    <div class="w-full">
      <div class="flex flex-row justify-between items-center">
        <h2 class="text-lg font-bold text-black">{{chat.name}}</h2>
        <div class="text-sm">
      ...
      <div class="flex justify-between">
        <p class="text-xs text-gray-500" v-html="chat.lastMessage"></p>
